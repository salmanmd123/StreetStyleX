...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            <Link to='/' ><img src={assets.logo} className='w-45' alt="logo" /></Link>
            ...
            <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
                ...
                <NavLink to='/kidswear' className='flex flex-col items-center gap-1'>
                    <p>KIDSWEAR</p>
                    <hr className='w-2/4 border-none h-[1.5px] bg-gray-700 hidden' />
                </NavLink>
            ...
            <div className='flex items-center gap-6'>
                ...
                <Link to='/cart' className='relative'>
                    <img src={assets.cart_icon} className='w-5 min-wid-5' alt="cart-icon" />
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border ' to={'/kidswear'}>KIDSWEAR</NavLink>
